    ...
    <nav className="fixed top-4 left-4 right-4 z-50">
      <div className="mx-auto max-w-5xl rounded-2xl bg-ink/60 backdrop-blur-xl border border-white/[0.08] px-6 py-3 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-2 group">
          <div className="w-8 h-8 rounded-lg bg-pillar-data/20 flex items-center justify-center group-hover:bg-pillar-data/30 transition-colors">
            <Terminal className="w-4 h-4 text-pillar-data" />
          </div>
